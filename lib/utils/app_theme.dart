...
class AppTheme {
  ...
  static const Color iconColor = ColorPalette.primary;

  static const Color lightPrimaryColor = ColorPalette.white;
  static const Color darkPrimaryColor = Colors.grey;
  static const Color lightPrimaryVarientColor = ColorPalette.primary;
  static const Color darkPrimaryVarientColor = ColorPalette.primary;

  static const Color lightSecondaryColor = ColorPalette.dark;
  static const Color darkSecondaryColor = ColorPalette.dark;
  static const Color lightOnPrimaryColor = ColorPalette.secondary;
