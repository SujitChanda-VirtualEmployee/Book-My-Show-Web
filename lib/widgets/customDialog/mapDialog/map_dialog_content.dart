...
class MapDialogContent extends StatefulWidget {
  ...
  const MapDialogContent({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _MapDialogContentState createState() => _MapDialogContentState();
}
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                  _locating
                                      ? ' Locating....'
                                      : locationData.currentLocation.city ==
                                              null
                                          ? ' Locating...'
                                          : " ${locationData.currentLocation.street!}, ${locationData.currentLocation.locality!}",
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          _locating
                              ? ''
                              : locationData.currentLocation.city == null
                                  ? ''
                                  : locationData
                                      .currentLocation.placeFormattedAddress!,
